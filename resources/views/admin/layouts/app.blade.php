...
<body class="bg-gray-100 text-gray-800" x-data="{ sidebarOpen: false }">
    ...
    <!-- SIDEBAR -->
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transition-transform duration-300 ease-in-out flex flex-col"
        :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'">
        
        <!-- Brand Logo -->
        <div class="h-16 flex items-center px-6 border-b border-gray-100 flex-shrink-0 justify-between lg:justify-start">
    ...
    <div id="main-content" class="relative flex flex-col min-h-screen transition-all duration-300">
        <!-- Header -->
        <header class="h-16 bg-white border-b border-gray-200 sticky top-0 z-40 flex items-center justify-between px-4 lg:px-8 flex-shrink-0">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <!-- Dropdown Menu -->
                    <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" class="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                        ...
                        <a href="{{ route('admin.profile') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">
