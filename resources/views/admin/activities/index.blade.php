    ...
    <div x-data>
        ...
        <x-modal id="createActivityModal" title="Tambah Kegiatan Baru" maxWidth="2xl">
            <form action="{{ route('admin.activities.store') }}" method="POST">
                ...
                <div class="space-y-5">
                    <div>
                        <label for="name" class="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Nama
                            Kegiatan</label>
                    ...
                    <div>
                        <label for="description"
                            class="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Deskripsi
                            (Opsional)</label>
            ...
            <div x-data="{ activity: { id: '', name: '', description: '' } }"
                ...
                <form :action="`{{ url('admin/activities') }}/${activity.id}`" method="POST">
                    ...
                    <div class="space-y-5">
                        <div>
                            <label for="edit_name"
                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200 mb-2">Nama
                                Kegiatan</label>
