        ...
        <div id="hs-header-classic"
            ...
            <div
                ...
                <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
                    ...
                    <a class="p-2 flex items-center text-sm hover:text-blue-500 focus:outline-none focus:text-blue-500 {{ Route::is('events*') ? 'text-blue-600 font-bold' : 'text-gray-800' }}"
